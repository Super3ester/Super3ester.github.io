...
$form['form-calculation'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма расчета (под шапкой)',
		'title' => 'Форма расчета (под шапкой)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'admin',
...
$form['form-calculation2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма расчета (определить размер)',
		'title' => 'Форма расчета (определить размер)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'admin',
