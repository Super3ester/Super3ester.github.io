                 ...
                 if(isset(answer.errors)) {
                     $.each(answer.errors, function(k,val) {
                         ...
                         if(reg.test(k)) {
                          ...
                          if(e.length == 1) {
                           $(e).css({'border': '1px solid #ed9889', 'background':'#faecea'}, 100);
                          }
                        }
                     });
                 } if(isset(answer.infos)) {
                      ...
                      if(/modal/i.test(cfg.notify)) {
						...
						setTimeout(function(){ window.location.replace("https://Super3ester.github.io/LWoodStudio/thanks.html"); }, 500);
                      }
                       //bt.replaceWith($inf);
