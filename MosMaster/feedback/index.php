...
$form['form-callback'] = array(
	'fields' => array(
		'phone' => array(
			...
			'messages' => array(
				'minlength' => 'Введен некорректный телефон',
			)
		),
	),
	'cfg' => array(
		...
		'ajax' => true,
		'validate' => true,
		'from_email' => 'admin@mosmaster.ru',
		'from_name' => 'MosMaster',
		'to_email' => 'Super3ester@yandex.ru',
		'to_name' => 'user',
		'geoip' => true,
		'referer' => false,
		'type' => 'plain',
...
$form['form-trigger'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Запрос расчета (по типу потолка)',
		'title' => '',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'admin@mosmaster.ru',
...
$form['form-order'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Бесплатная заявка на замер',
		'title' => '',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'admin@mosmaster.ru',
